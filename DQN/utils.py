...
class PreprocessState:
    def __init__(self):
        self.transform = T.Compose([
            ...
            T.Grayscale(num_output_channels=1),  # 转为灰度图
            T.Resize((84, 84)),  # 缩放到 84x84
    ...
    def log(self, epoch, metric_value, loss=None, env=None, episode=None, record_newest=False):
        ...
        if epoch % self.log_interval == 0:
            ...
            if metric_value > self.best_score:
                ...
                self.logger.info(f"New best score: {self.best_score}, saving model and video.")
